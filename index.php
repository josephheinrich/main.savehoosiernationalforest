...
<head>
  ...
  <meta property="og:title" content="Save Hoosier National Forest | Stop the Buffalo Springs proposal">
    ...
    <div class="intro">
      ...
      <div class="intro-main">
        <div class="container mb-5 d-flex justify-content-center align-items-center">
          ...
          <div class="card shadow-lg rounded w-100 text-center" id="countdowncard">
            <div class="card-header text-white" style="background-color: rgb(14, 79, 20);">
              Help save Hoosier National Forest and stop the Buffalo Springs Project by clicking the button below and signing our petition!
            </div>
            <!-- <h5 class="card-header text-white" style="background-color: rgb(14, 79, 20);">Action alert!</h5> -->
            <div class="card-body" style="padding: 0rem 1rem 1rem 1rem !important;">
              <p class="card-text">
                <div id="countdown" class="text-center">
                  <ul class="mb-0" style="padding-inline-start: 0px;">
                    <li><span id="days"></span>days left to sign</li>
                  </ul>
                </div>
              </p>
              <a href="https://www.change.org/p/united-states-department-of-agriculture-usda-protect-the-hoosier-national-forest?recruiter=619619048&utm_source=share_petition&utm_medium=facebook&utm_campaign=psf_combo_share_initial&recruited_by_id=c2f42520-9d55-11e6-8773-3f12f604ecf6&share_bandit_exp=initial-31332819-en-US&utm_content=fht-31332819-en-us%3A0" target="_blank" class="btn btn-success" style="background-color: rgb(14, 79, 20);">Sign Petition</a>
            </div>
          </div>
        </div>
      ...
      <img class="background-image" src="assets/images/tree-background-2.webp" />
    </div>
    <!--end .intro-->
        ...
        <div class="col-12 mb-3">
          <div class="text-center">
            <h5 style="color:rgb(130, 130, 130);">
              To help conserve the future of Hoosier National Forest please contact the elected officials below to voice
              your opinion.
            </h5>
          </div>
        </div>
      ...
      <div class="row gy-3">
        ...
        <div class="col-12 event-item">
          <div>
            ...
            <p style="margin-top: 0px; color: rgb(140, 140, 140);">
              <a href="https://drive.google.com/drive/folders/16JlSuAMkdwAFEQW4Yiyu6yziexbqetLN?usp=sharing"
                target="_blank">SaveHNF Resources</a>
            </p>
            <p>
              Check out the <a
                href="https://drive.google.com/drive/folders/16JlSuAMkdwAFEQW4Yiyu6yziexbqetLN?usp=sharing"
                target="_blank">SaveHNF public Google Drive</a> to view documents from the National Forest Service,
              press releases, past newsletters, and general information about the Buffalo Springs Restoration Project.
            </p>
          </div>
        </div>
      </div>
...
<script>
  (function () {
    ...
    let today = new Date(),
      ...
      nextYear = yyyy + 1,
      dayMonth = "12/16/",
      countdownday = dayMonth + yyyy;

    today = mm + "/" + dd + "/" + yyyy;
    if (today > countdownday) {
      countdownday = dayMonth + nextYear;
    }
    //end
    const d = new Date("2022-12-17");
    const countDown = new Date(countdownday).getTime(),
